...
export const FormularioV2 = ({ mensajeState, mostrarMensaje, compoDisabledDocument, boton, aniosLaborados, edad, setEdad, stateEdadAntiguedad, stateLenguajeShow, stateLenguaje, handleSubmit, setMeta, meta, handleCancel, componentButtonDisabled, componentDisabled, compoDisabled, setError, error }) => {
        ...
        <div className="contenedorFormulario" >
            ...
            <Form onSubmit={onSubmit} className='formularioEmpleado'>
                ...
                <Form.Item label="Tipo de documento" required>
                    <Select id='documentTypeId' value={documentTypeId} onChange={(value) => handleFormChange('documentTypeId', value)} placeholder="Selecciona un tipo de documento" style={{ width: 220 }} disabled={compoDisabled}>
